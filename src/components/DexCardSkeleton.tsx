...
const DexCardSkeleton = () => {
  return (
    <DexCardWrapper className="animate-pulse rounded-3xl overflow-hidden shadow-lg flex flex-row p-5 opacity-25">
      <div className="pokemon-container">
        <div className="pokemon bg-info rounded-full pokeball" />
      </div>
